                            ...
                            SizedBox(
                              ...
                              child: ListView(
                                ...
                                children: List.generate(
                                  data == null
                                      ? _provider.uniList?.length
                                      : data.docs[categoryindex]['url'].length,
                                  (index) {
                                    var selectedDoc = data.docs[categoryindex];
                                    _provider.getPrefData(index);
                                    ...
                                    return Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          selectedDoc['url'][index] != null
                                              ? ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(20),
                                                  child: data == null
                                                      ? Image.memory(_provider
                                                              .uniList?[index]
                                                          as Uint8List)
                                                      : Image.network(
                                                          selectedDoc['url']
